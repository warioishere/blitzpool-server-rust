...
pub use client::{
    bulk_touch_clients_for_share, delete_client_for_session,
    delete_old_client_difficulty_statistics, delete_old_client_rejected_statistics,
    count_pool_workers_by_slot, delete_old_client_statistics, delete_old_clients,
    delete_old_pool_mode_hashrate, find_client, find_client_difficulty_statistics,
    ...
    find_client_statistics_since, find_client_statistics_since_for_address, find_clients_by_address,
    find_user_agents, find_worker_shares, kill_dead_clients, sum_active_pool_hashrate,
    sum_hashrate_for_addresses, touch_client_for_share, update_sv2_user_agent_by_address,
    upsert_address_best_difficulty, upsert_client, upsert_client_difficulty_statistic,
    ClientDifficultyStatisticsRow, ClientRejectedStatisticsRow, ClientRow, ClientStatisticsRow,
    ClientUpsert, PoolWorkerSlotCount, UserAgentAggRow, WorkerSharesRow,
};
pub use email::{
